...
function mountCompany(){
  ...
  $("co_save").onclick=async ()=>{
    ...
    const data={name:$("co_name").value.trim(),address:$("co_addr").value.trim(),phoneSales:$("co_phone").value.trim(),footerNote:$("co_note").value.trim(),updatedAt:serverTimestamp(),iso:iso()};
