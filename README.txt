...
ملاحظة:
- تعديل/حذف الفواتير للأدمن فقط (حسب القواعد المقترحة).
- يمكن تخصيص شكل الفاتورة 100% حسب نموذجك.


بيانات دخول الأدمن الأساسي:
- المستخدم: Admin (أو البريد: admin@erp.local)
- كلمة المرور: Admin123

ملاحظة: شاشة إعداد Firebase مخفية افتراضياً. لفتحها استخدم الرابط مع ?setup=1
مثال: https://YOUR_GITHUB_PAGES_URL/?setup=1#
